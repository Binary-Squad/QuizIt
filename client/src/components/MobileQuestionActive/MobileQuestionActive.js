          ...
          <ListGroup className="list-group-mobile">
            {answers.map(answer => (
              <ListGroupItem
                ...
                className={
                  this.props.currentAnswer === this.props.correctAnswer && answer === this.props.correctAnswer ? "mobile-correct mobile-answer-box" :
                  answer === this.props.correctAnswer ? "mobile-correctAnswer mobile-answer-box" : 
